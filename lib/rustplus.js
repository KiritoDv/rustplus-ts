...
class RustPlus extends events_1.default {
    ...
    connect() {
        ...
        protobuf.load(path_1.default.resolve(__dirname, "rustplus.proto")).then((root) => {
    ...
    sendRequest(data, callback) {
        ...
        let request = this.AppRequest.fromObject(Object.assign({ seq: currentSeq, playerId: this.playerId, playerToken: this.playerToken }, data));
